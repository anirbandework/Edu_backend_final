...
async def create_quiz_data():
    """Create sample quiz data using existing tenant"""
    
    async for db in get_db():
        try:
            # Use existing tenant
            tenant_id = "f0ff1f52-e06e-4733-b0bb-c391c7783054"  # Lakeside Middle School
            ...
            await db.commit()
            print("Quiz data creation completed!")
            print(f"Use tenant_id: {tenant_id}")
            print(f"Use topic_id: {topic_id}")
