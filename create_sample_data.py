...
from app.models.tenant_specific.quiz import Topic, Question, QuestionType, DifficultyLevel
from sqlalchemy import text

async def create_sample_data():
    """Create sample topics and questions for testing"""
    
    async for db in get_db():
        try:
            # Sample tenant ID (use the one from your tests)
            ...
            if question_count == 0:
                ...
                questions = [
                    ...
                    {
                        "id": str(uuid4()),
                        "question_text": "Solve the system: 2x + y = 7, x - y = 2",
                        "question_type": "short_answer",
                        "difficulty_level": "medium",
                        "options": None,
                        "correct_answer": "x = 3, y = 1",
                        "explanation": "Add equations: 3x = 9, so x = 3. Substitute: y = 1",
                        "points": 2
                    }
                ]
