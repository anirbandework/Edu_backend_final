...
from app.models.tenant_specific.assesment.quiz_question_models import Topic, Question, Quiz, QuizQuestion, QuizAttempt, QuizAnswer, quiz_classes
...
class QuizService:
    ...
    async def create_question(self, db: AsyncSession, question_data: QuestionCreate, tenant_id: UUID) -> Question:
        ...
        if category_ids:
            from app.models.tenant_specific.assesment.quiz_question_models import Category
